...
- Next: Firebase human runbook (`docs/deployment/01`) → Firestore swap (`docs/deployment/02`) → RC checklists (`docs/deployment/03`). AI providers: implement AiChatModel per vendor + bind in `aiServicesProvider`. Deferred lists: ADR-0009/0010.
