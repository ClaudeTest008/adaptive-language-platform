...
- Next: Epic 14 Firebase production integration — human runbook first (`docs/deployment/01-firebase-setup.md`), then Firestore implementations of all five repository interfaces; swap point = provider bindings only. Then Content Studio spec remainder (docs/product/07) + admin analytics.
