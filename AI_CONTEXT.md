...
- Next: Epic 14 Firebase production integration — human runbook first (`docs/deployment/01-firebase-setup.md`), then follow `docs/deployment/02-firestore-swap-guide.md` (five repository implementations, rules/index deltas incl. status-enum gate, migration scripts, verification checklist). Deferred V2 items listed in ADR-0009.
