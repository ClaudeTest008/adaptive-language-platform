...
void main() {
  test(
    'mock exam controller: select answers, submit, score and persist',
    () async {
      ...
      final attempts = await container
  ...
  test(
    'mock exam controller: unanswered submission fails and feeds incorrect pool',
    () async {
      final container = ProviderContainer();
      addTearDown(container.dispose);
      ...
      final incorrect = await container
          .read(studyRepositoryProvider)
